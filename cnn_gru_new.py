...
class AttentionConvGRUClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_classes):
        super(AttentionConvGRUClassifier, self).__init__()
        ...
        self.relu = nn.ReLU()
        self.gru = nn.GRU(input_size=64, hidden_size=hidden_dim, num_layers=2, batch_first=True, dropout=0.3)
...
# Initialize Model
model = AttentionConvGRUClassifier(input_dim=len(feature_cols), hidden_dim=96, num_classes=num_classes)
